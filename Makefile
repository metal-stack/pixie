...
ipxe:
	...
	(cd ipxe/ipxe/src &&\
		make bin/ipxe.pxe bin/undionly.kpxe \
			bin-x86_64-efi/ipxe.efi bin-i386-efi/ipxe.efi \
			bin-x86_64-efi/snponly.efi bin-i386-efi/snponly.efi \
			EMBED=../../../pixiecore/boot.ipxe)
